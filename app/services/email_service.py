...
def send_email_with_excel(
    ...
    """Send an email via Outlook/Exchange with optional Excel attachment."""
    ...
    try:
        ...
        intro = (
            "<p>Prezado(a),</p>"
            "<p>Eu gostaria de compartilhar uma breve amostra no material anexo.</p>"
        )
        ...
        # Create Excel attachment if data provided
...
def export_to_excel_bytes(data: dict) -> bytes:
    """Convert query result data to Excel bytes."""
